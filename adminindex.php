...
<h1 class="text-center my-5">Welcome Back Admin</h1>
<p class="fs-4 text-center text-primary">Total Orders
    <?php 
    include("config.php");
    $query="SELECT count(*) as total from `order`";
    $result=mysqli_query($connect,$query);
    $data=mysqli_fetch_assoc($result);
    echo "<strong>".$data['total']."</strong>";
    ?>
</p>
<div class="container my-5">
        <h1 class="text-center my-3">Recent Orders</h1>
        <?php
        if(isset($_GET['msg'])){
          ?>
        ...
        <a class="btn btn-primary w-25 my-3 mx-auto d-block" href="viewbooking.php">View All Orders</a>
    </div>
    <?php
